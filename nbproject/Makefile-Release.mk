...
${OBJECTDIR}/area_editor.o: area_editor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/area_editor.o area_editor.cpp
...
${OBJECTDIR}/dungeon_gen.o: dungeon_gen.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dungeon_gen.o dungeon_gen.cpp
...
${OBJECTDIR}/range.o: range.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/range.o range.cpp
